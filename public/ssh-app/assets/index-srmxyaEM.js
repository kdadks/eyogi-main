import { g as getAugmentedNamespace } from "./vendor-Bkix9UhF.js";
const zlib = {};
var publicApi = {};
var URL$2 = { exports: {} };
var conversions = {};
...
const URL = zlib.URL || publicApi.URL;
...
function getNodeRequestOptions(request) {
  ...
  if (request.signal && request.body instanceof zlib.Readable && !streamDestructionSupported) {
...
function fetch(url, opts) {
  ...
  return new fetch.Promise(function(resolve, reject) {
    ...
    const abort = function abort2() {
      ...
      reject(error2);
      if (request.body && request.body instanceof zlib.Readable) {
...
//# sourceMappingURL=index-srmxyaEM.js.map
