...
export function generateStudentId(): string {
  ...
  const currentYearUsers = existingUsers.filter(u => 
    ...
    const defaultGurukuls = [
      {
        ...
        slug: 'hinduism',
        description: 'Explore the rich traditions, philosophy, and practices of Hinduism through comprehensive courses designed for all age groups.',
      ...
      },
      {
        ...
        name: 'Mantra Gurukul',
        slug: 'mantra',
        description: 'Learn the sacred science of mantras, their pronunciation, meanings, and transformative power in spiritual practice.',
      ...
      },
      {
        ...
        slug: 'philosophy',
        description: 'Dive deep into ancient philosophical traditions and their relevance to modern life and spiritual growth.',
      ...
      },
      {
        ...
        slug: 'sanskrit',
        description: 'Master the sacred language of Sanskrit through structured learning programs for beginners to advanced students.',
      ...
      },
      {
        ...
        slug: 'yoga-wellness',
        description: 'Integrate physical, mental, and spiritual wellness through traditional yoga practices and holistic health approaches.',
    ...
    const defaultCourses = [
      {
        ...
        description: 'An introduction to Hindu traditions, festivals, and basic concepts designed for children aged 8-11 years.',
        level: 'basic',
        age_group_min: 8,
        age_group_max: 11,
        duration_weeks: 6,
      ...
      },
      {
        ...
        description: 'Explore deeper philosophical concepts of Hinduism suitable for teenagers aged 12-15 years.',
        level: 'intermediate',
        age_group_min: 12,
        age_group_max: 15,
        duration_weeks: 8,
