import { LocalUser, generateId, generateStudentId, storeUser, findUserByEmail, storeSession, clearSession, getCurrentSession } from './storage'
...
export async function signUp(email: string, password: string, userData: Partial<LocalUser>) {
  ...
  const newUser: LocalUser = {
    ...
    student_id: userData.role === 'student' ? generateStudentId() : null,
