...
export class ResponseGenerator {
  ...
  private generateDidYouKnowResponse(message: string, persona: string, user: User | null): string {
  ...
  private extractSpecificQuery(message: string): string {
    ...
    const topics = [
      'sanskrit', 'yoga', 'hinduism', 'hindu', 'philosophy', 'mantra', 'mantras',
      'meditation', 'dharma', 'karma', 'festival', 'festivals', 'ayurveda',
      'vedic', 'vedas', 'guru', 'gurukul', 'om', 'namaste', 'chakra', 'chakras',
      'pranayama', 'asana', 'asanas', 'bhagavad gita', 'upanishads', 'ramayana',
      'mahabharata', 'diwali', 'holi', 'navratri', 'ganesh', 'shiva', 'vishnu',
      'brahma', 'lakshmi', 'saraswati', 'hanuman', 'krishna', 'rama'
    ]
  ...
  private addIntentBasedLinks(intent: string, persona: string): string {
  ...
  private generateFallbackResponse(intent: string, persona: string): string {
  ...
  private addPersonalizedTouches(response: string, user: User | null, persona: string, intent: string): string {
    if (user) {
  ...
  private generateSuggestions(intent: string, persona: string): string {
