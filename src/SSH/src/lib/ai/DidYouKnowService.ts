  ...
  private initializeFacts() {
    this.facts = [
      // Hinduism & Philosophy Facts
      {
        id: 'fact-1',
        content:
          'The word "Guru" comes from Sanskrit meaning "dispeller of darkness" - Gu (darkness) + Ru (to remove). A Guru guides students from ignorance to knowledge! 🌟',
        category: 'hinduism',
      ...
      },
      {
        id: 'fact-2',
        content:
          'Sanskrit has 54 letters in its alphabet, and each letter is believed to have a specific vibration that affects consciousness when pronounced correctly! 🕉️',
        category: 'sanskrit',
      ...
      },
      {
        id: 'fact-3',
        content:
          "The ancient Gurukul system was the world's first residential university system, where students lived with their teachers and learned through practical experience! 🏫",
        category: 'education',
      ...
      },
      {
        id: 'fact-4',
        content:
          'Yoga means "union" in Sanskrit - the union of individual consciousness with universal consciousness. It\'s much more than physical exercise! 🧘‍♀️',
        category: 'yoga',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student'],
      },
      {
        id: 'fact-5',
        content:
          'The Om symbol (🕉️) represents the sound of the universe and contains three curves representing waking, dreaming, and deep sleep states of consciousness!',
        category: 'symbols',
      ...
      // Learning & Education Facts
      {
        id: 'fact-6',
        content:
          'Studies show that learning ancient languages like Sanskrit can improve memory, concentration, and cognitive function in children! 🧠',
        category: 'learning',
      ...
      },
      {
        id: 'fact-7',
        content:
          'The traditional Gurukul education emphasized character building alongside academic learning - a holistic approach we maintain in our online courses! ✨',
        category: 'education',
      ...
      },
      {
        id: 'fact-8',
        content:
          'Mantras are not just words - they are sound formulas that create specific vibrations in the mind and body, promoting healing and spiritual growth! 🎵',
        category: 'mantras',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student'],
      },
      {
        id: 'fact-9',
        content:
          'The concept of "Dharma" doesn\'t just mean religion - it means righteous living, duty, and the natural order that maintains harmony in the universe! ⚖️',
        category: 'philosophy',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      {
        id: 'fact-10',
        content:
          'Ancient Indian mathematics gave the world the concept of zero, decimal system, and many algebraic principles that form the foundation of modern mathematics! 🔢',
      ...
      // Festival & Culture Facts
      {
        id: 'fact-11',
        content:
          'Diwali, the Festival of Lights, symbolizes the victory of light over darkness and knowledge over ignorance - core principles we teach in our courses! 🪔',
        category: 'festivals',
        intent: ['course_inquiry', 'gurukul_information'],
      ...
      },
      {
        id: 'fact-12',
        content:
          "The lotus flower is sacred in Hinduism because it grows from muddy water yet remains pure and beautiful - symbolizing spiritual growth through life's challenges! 🪷",
        category: 'symbols',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student'],
      },
      {
        id: 'fact-13',
        content:
          'Ayurveda, the ancient science of life, recognizes that each person has a unique constitution and requires personalized approaches to health and wellness! 🌿',
        category: 'ayurveda',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'parent'],
      },
      {
        id: 'fact-14',
        content:
          "The ancient text Bhagavad Gita is considered one of the world's greatest philosophical works, offering practical wisdom for ethical living and spiritual growth! 📖",
        category: 'texts',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      {
        id: 'fact-15',
        content:
          'Meditation has been practiced for over 5,000 years and modern science now confirms its benefits for stress reduction, focus, and emotional well-being! 🧘',
        category: 'meditation',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'parent'],
      },
      ...
      // Platform & Technology Facts
      {
        id: 'fact-16',
        content:
          'Our platform uses AI to personalize learning paths, ensuring each student receives content appropriate for their age, level, and learning style! 🤖',
        category: 'technology',
      ...
      },
      {
        id: 'fact-17',
        content:
          "Students from over 25 countries have joined our global eYogi community, creating a diverse learning environment that enriches everyone's experience! 🌍",
        category: 'community',
      ...
      },
      {
        id: 'fact-19',
        content:
          'We offer courses in three delivery methods - online, in-person, and hybrid - to accommodate different learning preferences and global accessibility! 💻',
        category: 'delivery',
      ...
      },
      {
        id: 'fact-20',
        content:
          'Our teachers are certified experts with deep knowledge of Vedic traditions, ensuring authentic and accurate transmission of ancient wisdom! 👨‍🏫',
        category: 'teachers',
      ...
      // Age-Appropriate Learning Facts
      {
        id: 'fact-21',
        content:
          'Children as young as 4 can start learning basic concepts through stories, songs, and interactive activities designed specifically for their developmental stage! 👶',
      ...
      },
      {
        id: 'fact-22',
        content:
          'Teenagers often find ancient philosophy surprisingly relevant to modern challenges like stress, relationships, and finding life purpose! 🧠',
        category: 'age_learning',
        intent: ['age_appropriate', 'course_inquiry'],
        persona: ['parent', 'prospective_student'],
      },
      {
        id: 'fact-23',
        content:
          'Adult learners bring life experience that enriches philosophical discussions, making our courses valuable for lifelong learning! 👩‍🎓',
        category: 'age_learning',
        intent: ['age_appropriate', 'course_inquiry'],
      ...
      // Spiritual & Cultural Facts
      {
        id: 'fact-24',
        content:
          'The concept of "Vasudhaiva Kutumbakam" means "the world is one family" - a principle that guides our inclusive, global approach to education! 🌏',
        category: 'philosophy',
        intent: ['about_eyogi', 'gurukul_information'],
      ...
      },
      {
        id: 'fact-25',
        content:
          'Pranayama (breathing exercises) can be practiced by anyone and has immediate benefits for stress relief and mental clarity! 🌬️',
        category: 'yoga',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'parent'],
      },
      ...
      // Continue with more facts... (I'll add more in batches to stay within reasonable limits)
      {
        id: 'fact-26',
        content:
          'The ancient Indian concept of "Ahimsa" (non-violence) influenced great leaders like Mahatma Gandhi and Martin Luther King Jr.! ✌️',
        category: 'philosophy',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      {
        id: 'fact-27',
        content:
          'Sanskrit is considered the mother of many languages and has influenced vocabulary in English, German, Latin, and other Indo-European languages! 🗣️',
        category: 'sanskrit',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'parent'],
      },
      {
        id: 'fact-28',
        content:
          'The practice of meditation can physically change brain structure, increasing gray matter in areas associated with learning and memory! 🧠',
        category: 'meditation',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'parent'],
      },
      {
        id: 'fact-29',
        content:
          "Ancient Indian astronomy accurately calculated the Earth's circumference, the speed of light, and planetary movements thousands of years ago! 🌟",
        category: 'science',
        intent: ['course_inquiry', 'about_eyogi'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      {
        id: 'fact-30',
        content:
          'The concept of "Karma" is often misunderstood - it\'s not about punishment but about the natural law of cause and effect in moral actions! ⚖️',
        category: 'philosophy',
        intent: ['course_inquiry', 'gurukul_information'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      ...
      // Additional Educational Facts
      {
        id: 'fact-31',
        content:
          'The ancient Indian mathematician Aryabhata calculated the value of π (pi) to four decimal places in 499 CE, centuries before European mathematicians! 🔢',
        category: 'science',
      ...
      },
      {
        id: 'fact-32',
        content:
          'The word "Guru" literally means "from darkness to light" - Gu (darkness) + Ru (light). A true Guru illuminates the path of knowledge! 💡',
        category: 'education',
      ...
      },
      {
        id: 'fact-33',
        content:
          'Yoga has 84 classic asanas (poses), each designed to benefit specific organs and energy centers in the body! 🧘‍♀️',
        category: 'yoga',
        intent: ['course_inquiry', 'did_you_know'],
        persona: ['student', 'prospective_student'],
      },
      {
        id: 'fact-34',
        content:
          'The Vedic chant "Asato Ma Sad Gamaya" means "Lead me from falsehood to truth, from darkness to light, from death to immortality" 🌟',
        category: 'mantras',
        intent: ['course_inquiry', 'did_you_know'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
      {
        id: 'fact-35',
        content:
          'Ancient Indian texts described the concept of multiple universes (multiverse) thousands of years before modern physics! 🌌',
        category: 'science',
        intent: ['course_inquiry', 'did_you_know'],
        persona: ['student', 'prospective_student', 'general_visitor'],
      },
