...
export default async function AboutUsPage() {
  try {
        ...
        <div className="bg-white">
          <section className="py-16 container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                {result?.whatIsGurukul?.description && (
                  <RichText
            ...
            <div className="container mx-auto px-4">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1 relative h-80 md:h-96 rounded-xl overflow-hidden shadow-xl">
                  {result?.whatIsEYogiGurukul?.photo && (
                    <Media
                ...
                <div className="order-1 md:order-2">
                  ...
                  {result?.whatIsEYogiGurukul?.description && (
                    <RichText
                      className="text-gray-700"
          ...
          <section className="py-16 container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                Explore our gallery of memorable moments, classes, events, and celebrations from
                over the years.
              </p>
            </div>
            <Tabs defaultValue="photos" className="w-full">
              ...
              <TabsContent value="videos" className="mt-8 p-0">
                {result?.gallery?.ytLinks && <GalleryYt ytLinks={result.gallery.ytLinks} />}
              </TabsContent>
            </Tabs>
          </section>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="relative rounded-xl overflow-hidden aspect-video shadow-xl before:content-[''] before:absolute before:inset-0 before:z-10 hover:before:pointer-events-none before:pointer-events-auto">
                  {result?.lecturesAndWorkshops?.[0]?.ytLink && (
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    Our public lectures and workshops are designed to introduce the richness of
                    Indian Knowledge Systems to a wider audience. These sessions cover a range of
                    topics including:
                  </p>
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        <strong>Modern Applications:</strong> Applying ancient wisdom to
                  ...
                  <p className="text-gray-700">
                    ...
                    traditional knowledge in today&apos;s world, often inspiring participants to
                    join our more comprehensive courses.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                Our graduation ceremonies are joyous occasions that honor students&apos;
                achievements and showcase their learning journey.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                {result?.graduationEvents?.description && (
                  <RichText
                    className="text-gray-700"
    ...
    // Return a fallback UI when data fails to load
    return (
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About eYogi Gurukul</h1>
          <p className="text-xl text-gray-600 mb-8">
            We&apos;re having trouble loading our content right now. Please try again later.
          </p>
