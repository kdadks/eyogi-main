...
export default function Hero() {
  return (
    <div className="w-full h-[calc(100svh-80px)] flex flex-col justify-between gap-8 bg-[#0D0B09] text-white">
      <div className="relative flex overflow-x-hidden w-full min-h-[max(20vw,200px)] items-center mt-8 lg:mt-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 min-w-[200px] min-h-[200px] xl:w-[20vw] xl:h-[20vw]">
          ...
          <div className="absolute w-full h-full overflow-hidden rounded-full">
            <div className="absolute -left-[100%] md:-left-[200%] top-1/2 pl-8 lg:pl-16 xl:pl-32 whitespace-nowrap animate-marquee flex text-[12vw] xl:text-[8vw] gap-8 lg:gap-16 xl:gap-32 flex-grow-0">
              <span>Spirituality</span>
              <span>&</span>
              <span>Dharma</span>
            </div>
      ...
      <div className="w-full flex justify-center items-center text-center flex-col gap-8 lg:gap-16 px-4">
        <p className="text-base md:text-2xl lg:w-1/2 font-medium italic font-mono text-white max-w-[800px]">
          Preserving ancient wisdom, inspiring young minds. Accessible, values-based education for a
          brighter future.
        </p>
      ...
      <div className="flex flex-row justify-between p-4 lg:p-16 text-white gap-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex lg:justify-between gap-4">
            <a href="http://www.linkedin.com/in/eyogi-gurukul-7a63a91a0" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity duration-300 flex items-center">
              <Linkedin className="w-6 h-6 md:w-8 md:h-8" />
            </a>
            <a href="http://www.twitter.com/@eyogigurukul" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity duration-300">
              <Twitter className="w-6 h-6 md:w-8 md:h-8" />
            </a>
            <a href="https://www.facebook.com/allfestivesireland#" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity duration-300">
              <Facebook className="w-6 h-6 md:w-8 md:h-8" />
            </a>
            <a href="https://www.youtube.com/channel/UCTytB2My0xSvNmtKBRIJnIg?" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity duration-300">
